...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        # Grafo da Paraíba
        self.g_p = GrafoMatrizAdjacenciaNaoDirecionado(['J', 'C', 'E', 'P', 'M', 'T', 'Z'])
        ...
        self.g_p_sem_paralelas = GrafoMatrizAdjacenciaNaoDirecionado(['J', 'C', 'E', 'P', 'M', 'T', 'Z'])
        ...
        # Grafos completos
        self.g_c = GrafoMatrizAdjacenciaNaoDirecionado(['J', 'C', 'E', 'P'])
        ...
        self.g_c2 = GrafoMatrizAdjacenciaNaoDirecionado(['Nina', 'Maria'])
        self.g_c2.adicionaAresta('amiga', 'Nina', 'Maria')

        self.g_c3 = GrafoMatrizAdjacenciaNaoDirecionado(['J'])

        # Grafos com laco
        self.g_l1 = GrafoMatrizAdjacenciaNaoDirecionado(['A', 'B', 'C', 'D'])
        self.g_l1.adicionaAresta('a1', 'A', 'A')
        self.g_l1.adicionaAresta('a2', 'A', 'B')
        self.g_l1.adicionaAresta('a3', 'A', 'A')

        self.g_l2 = GrafoMatrizAdjacenciaNaoDirecionado(['A', 'B', 'C', 'D'])
        self.g_l2.adicionaAresta('a1', 'A', 'B')
        self.g_l2.adicionaAresta('a2', 'B', 'B')
        self.g_l2.adicionaAresta('a3', 'B', 'A')

        self.g_l3 = GrafoMatrizAdjacenciaNaoDirecionado(['A', 'B', 'C', 'D'])
        ...
        self.g_l4 = GrafoMatrizAdjacenciaNaoDirecionado(['D'])
        self.g_l4.adicionaAresta('a1', 'D', 'D')

        self.g_l5 = GrafoMatrizAdjacenciaNaoDirecionado(['C', 'D'])
        self.g_l5.adicionaAresta('a1', 'D', 'C')
        self.g_l5.adicionaAresta('a2', 'C', 'C')

        # Grafos desconexos
        self.g_d = GrafoMatrizAdjacenciaNaoDirecionado(['A', 'B', 'C', 'D'])
