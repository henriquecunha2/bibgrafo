...
class TestGrafo(unittest.TestCase):
    ...
    def test_eq(self):
        ...
        g_p_eq.adiciona_aresta('a2', 'C', 'E')
        g_p_eq.adiciona_aresta('a3', 'C', 'E')
        g_p_eq.adiciona_aresta('a4', 'P', 'C')
        g_p_eq.adiciona_aresta('a5', 'P', 'C')
        g_p_eq.adiciona_aresta('a6', 'T', 'C')
        g_p_eq.adiciona_aresta('a7', 'M', 'C')
        g_p_eq.adiciona_aresta('a8', 'M', 'T')
        g_p_eq.adiciona_aresta('a9', 'T', 'Z')

        g_p_neq = MeuGrafo(['J', 'C', 'E', 'P', 'M', 'T', 'Z'])
        g_p_neq.adiciona_aresta('a1', 'C', 'C')
        g_p_neq.adiciona_aresta('a2', 'C', 'E')
        g_p_neq.adiciona_aresta('a3', 'C', 'E')
        g_p_neq.adiciona_aresta('a4', 'P', 'C')
        g_p_neq.adiciona_aresta('a5', 'P', 'C')
        g_p_neq.adiciona_aresta('a6', 'T', 'C')
        g_p_neq.adiciona_aresta('a7', 'M', 'C')
        g_p_neq.adiciona_aresta('a8', 'M', 'T')
        g_p_neq.adiciona_aresta('a9', 'T', 'Z')
